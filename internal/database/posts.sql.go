...
const craetePost = `-- name: CraetePost :one
...
func (q *Queries) CraetePost(ctx context.Context, arg CraetePostParams) (Post, error) {
	row := q.db.QueryRowContext(ctx, craetePost,
		arg.ID,
		arg.CreatedAt,
		arg.UpdatedAt,
		arg.Title,
